...
RDBMS is software for managing items in storage while SQL is more about querying relational dbs.

1. Why do tables need a `primary key`?

It is a unique identifer when you have info that exist on multiple tables.
